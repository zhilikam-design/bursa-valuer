...
const en: Dict = {
  ...
  "beta.title": "Beta — historical K-line regression",
  "beta.value": "Beta",
  "beta.raw": "Raw beta",
  "beta.blume": "Blume-adjusted",
  "beta.source.quant_regression": "Quant regression vs ^KLSE",
  "beta.source.sector_fallback": "Sector default",
  "beta.noRegression": "No regression sample — using sector default",
  "beta.chart.title": "Stock vs ^KLSE monthly returns",
  "beta.chart.x": "^KLSE monthly return",
  "beta.chart.y": "Stock monthly return",
  "beta.chart.point": "Monthly returns",
  "growth.dynamic": "Auto (dynamic)",
  "growth.source.roe": "ROE × retention",
  "growth.source.preset": "sector preset",
...
const zh: Dict = {
  ...
  "beta.title": "Beta — 历史K线回归",
  "beta.value": "Beta",
  "beta.raw": "原始 Beta",
  "beta.blume": "Blume 调整",
  "beta.source.quant_regression": "量化回归 vs ^KLSE",
  "beta.source.sector_fallback": "行业基准",
  "beta.noRegression": "回归样本不足 — 使用行业基准",
  "beta.chart.title": "个股 vs ^KLSE 月收益率",
  "beta.chart.x": "^KLSE 月收益率",
  "beta.chart.y": "个股月收益率",
  "beta.chart.point": "月度收益散点",
  "growth.dynamic": "自动（动态）",
  "growth.source.roe": "ROE × 留存率",
  "growth.source.preset": "板块预设",
